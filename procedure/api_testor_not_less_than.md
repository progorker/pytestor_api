...
def pytestor.api_testor_not_less_than( p_token, p_suite_id, p_case_id, p_code, p_operand, p_value ):
  # return p_test_id
...
test_code = 'not_less_than.1'
dbl_a = 24.3
dbl_b = 22.2
test_id = pytestor.api_testor_not_less_than( token, suite_id, case_id, test_code, dbl_a, dbl_b )
print( "\nTest ID: " + str(test_id) + "\n" )
...
Token: 3f9489cab7f8f76fcce016406a0779d5
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 11      | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
...
| case         | test            | message                                                                           |
+--------------+-----------------+-----------------------------------------------------------------------------------+
| test_numbers | not_less_than.1 | [not_less_than.1] test (not_less_than) is success. \nOperand: 24.3\nValue: 22.2\n |
+--------------+-----------------+-----------------------------------------------------------------------------------+
