...
def pytestor.api_testor_same( p_token, p_suite_id, p_case_id, p_code, p_operand, p_value ):
  # return p_test_id
...
str_a = 'Hello world!'
str_b = 'Hello world!'
test_id = pytestor.api_testor_same( token, suite_id, case_id, test_code, str_a, str_b )
print( "\nTest ID: " + str(test_id) + "\n" )
...
Token: 06fe8a565784b5d20bd7a23fc4943679
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 16      | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
...
| case         | test   | message                                                                         |
+--------------+--------+---------------------------------------------------------------------------------+
| test_numbers | same.1 | [same.1] test (same) is success. \nOperand: Hello world!\nValue: Hello world!\n |
+--------------+--------+---------------------------------------------------------------------------------+
