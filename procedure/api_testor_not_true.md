...
def pytestor.api_testor_not_true( p_token, p_suite_id, p_case_id, p_test_code, p_condition ):
  # return p_test_id
...
test_code = 'greater.1'
condition = 4 < 3
test_id = pytestor.api_testor_not_true( token, suite_id, case_id, test_code, condition )
print( "\nTest ID: " + str(test_id) + "\n" )
...
Token: af32b98545f3b13c63d205eee64fb149
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 14      | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
...
| case         | test      | message                                                                   |
+--------------+-----------+---------------------------------------------------------------------------+
| test_numbers | greater.1 | [greater.1] test (not_true) is success. \nCondition: 0\nExpected: false\n |
+--------------+-----------+---------------------------------------------------------------------------+
