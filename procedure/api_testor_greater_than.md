...
def pytestor.api_testor_greater_than( p_token, p_suite_id, p_case_id, p_code, p_operand, p_value ):
  # return p_test_id
...
Token: 9d551a4b054c802dae38f3fa96892f80
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 6       | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
