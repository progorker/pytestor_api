...
def pytestor.api_testor_less_than( p_token, p_suite_id, p_case_id, p_code, p_operand, p_value ):
  # return p_test_id
...
test_code = 'less_than.1'
dbl_a = 20.3
dbl_b = 22.2
test_id = pytestor.api_testor_less_than( token, suite_id, case_id, test_code, dbl_a, dbl_b )
print( "\nTest ID: " + str(test_id) + "\n" )
...
Token: 7d82dd22c6a928bb1a013cd98f2b65f1
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 7       | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
...
| case         | test        | message                                                                   |
+--------------+-------------+---------------------------------------------------------------------------+
| test_numbers | less_than.1 | [less_than.1] test (less_than) is success. \nOperand: 20.3\nValue: 22.2\n |
+--------------+-------------+---------------------------------------------------------------------------+
