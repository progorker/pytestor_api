...
def pytestor.api_testor_not_same( p_token, p_suite_id, p_case_id, p_code, p_operand, p_value ):
  # return p_test_id
...
test_code = 'not_same.1'
str_a = 'Hello world!'
str_b = 'Hello community!'
test_id = pytestor.api_testor_not_same( token, suite_id, case_id, test_code, str_a, str_b )
print( "\nTest ID: " + str(test_id) + "\n" )
...
Token: 62430a66c93409db7019a785958e2686
...
+---------+--------+---------------+----+---------------+--------------+------------+------------+
| 12      | GREEN  | pyTestorTrial | 1  | 1             | 0            | 1          | 1          |
+---------+--------+---------------+----+---------------+--------------+------------+------------+
